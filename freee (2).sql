...
--
-- Host: localhost
-- Generation Time: Nov 23, 2019 at 09:34 PM
...
CREATE TABLE `events` (
  ...
  `type` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'morning',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `events` (`id`, `event_start`, `event_end`, `capacity`, `location`, `type`, `created_at`, `updated_at`, `program_id`, `trainers`) VALUES
(1, '2019-11-25 19:00:00', '2019-11-17 00:00:00', 15, 'القاهره شمال شرق غرب مدينة نصر', 'morning', '2019-11-15 22:00:00', '2019-06-20 22:00:00', 4, 'ِAhmed safwat, ali salah'),
(2, '2019-11-29 00:00:00', '2019-11-17 00:00:00', 13, 'الجيزه جامعة القاهره', 'evening', '2019-11-15 22:00:00', '2019-11-15 22:00:00', 2, 'ِAhmed safwat, ali salah'),
(3, '2019-11-28 00:00:00', '2019-11-17 00:00:00', 15, 'القاهره شمال شرق غرب مدينة نصر', 'evening', '2019-11-15 22:00:00', '2019-06-20 22:00:00', 1, 'ِAhmed safwat, ali salah'),
(4, '2019-11-22 00:00:00', '2019-11-17 00:00:00', 13, 'الجيزه جامعة القاهره', 'morning', '2019-11-15 22:00:00', '2019-11-15 22:00:00', 6, 'ِAhmed safwat, ali salah');
...
('Ahmed.Safwat1235@gmail.com', '$2y$10$iO4IvlzWL44FX693QYvSTeuE//EF5iof7jiCG7KlN17wQzUoAU7CG', '2019-11-23 14:07:34');
