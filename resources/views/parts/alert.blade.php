@if(
Session::has("danger") || Session::has("warning") ||
Session::has("success") || Session::has("info") ||
count($errors) > 0
)
<div class="content" style="margin: 40px 0;">
	...
	@foreach (['danger', 'warning', 'success', 'info'] as $msg)
		@if(Session::has($msg))
		  ...
		  <div class="alert alert-{{ $msg }} alert-styled-right alert-arrow-right alert-bordered text-center" >
